				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Productos
						</div>
						<div class="card-body">
									...
									<tr>
										...
										<td><div align='center'>
												<a class="btn btn-primary me-2"
													href="procesaModificarProducto?id=<%=p.getId()%>"
													role="button">modificar</a><a class="btn btn-primary ms-2"
													href="procesaEliminarProducto?id=<%=p.getId()%>"
