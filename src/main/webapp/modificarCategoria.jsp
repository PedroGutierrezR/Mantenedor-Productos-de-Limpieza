		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container p-5">
					<form class="row g-3" action="procesaModificarCategoria"
						method="post">
						<h3 class="mb-4">
							Categoria con ID:
							<%=categoria.getIdCategoria()%></h3>
						<input type="hidden" value="<%=categoria.getIdCategoria()%>"
							name="idCategoria"></input>
						<div class="col-md-6">
							<label for="validationServer01" class="form-label">Nombre
								Categoría </label> <input name="nombreCategoria" type="text"
