	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="mx-5 mt-3">
					<%
					if (!exito.equals("no se ha podido completar la solicitud")) {
					%>
					<div
				...
				<div class="container p-5">
					<h3 class="mb-5">Nueva Categoría</h3>
					<form class="row g-3" action="procesaAgregarCategoria"
						method="post">
						<div class="col-md-6">
							<label for="validationServer01" class="form-label">Nombre
								Categoría </label> <input placeholder="Ej: Jabón Líquido"
								name="nombreCategoria" type="text" class="form-control"
